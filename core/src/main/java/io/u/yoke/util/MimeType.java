...
public class MimeType {
   ...
   */
  static {
    loadFile(MimeType.class.getClassLoader().getResourceAsStream("io/u/yoke/mime.types"));
    loadFile(MimeType.class.getClassLoader().getResourceAsStream("io/u/yoke/mimex.types"));
  }
